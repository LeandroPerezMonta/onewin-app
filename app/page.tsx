  ...
  return (
    <div className="min-h-screen w-full bg-[#090f1e] p-3">
      ...
      <div className={`pb-8 pt-4 w-full ${currentUser ? 'mb-[18rem]' : ''}`}>
        {currentUser ? (
          <div className="mt-8">
            <div className="w-full justify-center text-center"><h1 className="text-2xl font-bold mb-4">Metodos de Pago</h1></div>
            ...
            <AccordionItem
              ...
              title="Link de Trust"
            >
              <div className="my-4 flex text-2xl flex-col w-full items-center">
